# PRD — titikjiwa: Sanctuaries of Healing & Growth
...
- 2026-08-18 (sesi 21): Deploy auto-pull #1 GAGAL (b5fa1b3 — konflik litellm/emergentintegrations di pip + peer date-fns/react-day-picker di npm ci) → rollback 00c927e sukses. Deploy auto-pull #2 SUKSES: merge e3effae ke origin/main 691dec2 (rilis 1.0.6, fix deps upstream), pip OK, npm ci OK, build OK, health 200/200. Aplikasi kini versi "titikjiwa" dari repo raydiansyah/titikjiwa
- 2026-08-23 (sesi 22): Deploy auto-pull #3 SUKSES — merge f5a25f9 ke origin/main 50c104d (rilis 1.6.0: redesign hero dgn HeroCanvasArt/MindCanvas, tema gelap/terang, hardening auth). pip OK, npm ci OK, build OK, health 200/200, visual hero baru tampil. Catatan: ingress eksternal butuh ~15-30 dtk pasca restart (502 sementara itu normal)
...
- P2: Notifikasi real-time (websocket) menggantikan polling 30 detik
